...
<div class="filter-box">
    <form method="get" action="<?= $this->url->dir() ?>" class="search">
        ...
        <?= $this->form->text('search', $filters, array(), array('placeholder="'.t('Filter').'"', 'aria-label="'.t('Filter').'"'), 'input-addon-field') ?>
            ...
            <div class="input-addon-item">
                <div class="dropdown">
                <a href="#" class="dropdown-menu dropdown-menu-link-icon" title="<?= t('User filters') ?>" aria-label="<?= t('User filters') ?>"><i class="fa fa-users fa-fw"></i> <i class="fa fa-caret-down"></i></a>
                    <ul>
